                                                  ...
                                                  <div class="p-3">
                                                       <div class="d-flex justify-content-between align-items-center">
                                                            ...
                                                            <div class="d-flex align-items-center gap-2">
                                                                 <button type="button" class="btn btn-sm btn-outline-light" data-expand-target="#dash-performance-chart" title="Ampliar gráfico"><i class="bx bx-fullscreen"></i></button>
                                                       ...
                                                       <div class="alert alert-info mt-3 text text-truncate mb-0" role="alert">
                                                            Servidor com instabilidade no momento. Equipe já está atuando.
                                                       </div>
